...
const HeaderComponent = () => {
  ...
  const hambergerContainerRef = useRef()
  const navBarRef = useRef()
  const [isOpenHamberger, setIsOpenHamberger] = useState(false)

  useClickOutsideWith2Ref(hambergerContainerRef, navBarRef, () => {
    if (isOpenHamberger) {
  ...
  const toggleHambergerButton = () => {
    hambergerRef.current.classList.toggle('active')
    ...
    <>
      <Header id="header">
        ...
        <HambergerContainer ref={hambergerContainerRef}>
          ...
          >
            <HambergerBox>
              <HambergerInner ref={hambergerRef}></HambergerInner>
            </HambergerBox>
          </HambergerButton>
        </HambergerContainer>
      ...
      <SidePageLeft id="sideLeft" className="fadeIn">
        <SocialList>
          <li>
            <a
              href="https://github.com/ashlen152"
              aria-label="GitHub"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li>
            <a
              href="https://www.facebook.com/tpt1502/"
              aria-label="facebook"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li>
            <a
              href="https://www.instagram.com/kyou_reefer/"
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/trinhthinh152/"
              aria-label="linkedin"
              target="_blank"
              rel="noreferrer"
            >
